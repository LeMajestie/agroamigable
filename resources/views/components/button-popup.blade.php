    @if (session('modelOpen'))
        <script>
            // Open the modal using JavaScript or your modal library
                        ...
                        <div class="form-group">
                            <div>
                                <label for="name"
                                    ...
                                    completo</label>
                                <input placeholder="Maria Dolores" name="name"
                                ...
                                @error('name')
                                    <div class="alert alert-danger mt-1 mb-1 text-3xl text-red-600">{{ $message }}
                                    </div>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="mt-4">
                                ...
                                <select name="country" id="country"
                                    ...
                                    <option selected="Seleccione país" value="Seleccione país">Seleccione País</option>
                        ...
                        <div class="form-group">
                            <div class="mt-4">
                                ...
                                <select name="region" id="region"
                                    class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-lime-c100 border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40"
                                    placeholder="Seleccione país">
                                    <option selected="Seleccione país" value="Seleccione país">Seleccione Región
                                    </option>
                                </select>
                                @error('region')
                                    <div class="alert alert-danger mt-1 mb-1 text-3xl text-red-600">{{ $message }}
