...
<div x-data="{ modelOpen: debeestarabierto }">
    <button @click="modelOpen =!modelOpen; logMessage = 'Button with ID ' +{{$buttonid}}+ ' clicked'; console.log(logMessage)" class="rounded-full border-2 bg-orange-c500 border-orange-c500 hover:bg-transparent hover:text-orange-c500 text-white text-xl p-4">
