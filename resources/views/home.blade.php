    ...
    <div class="home bg-gradient-to-tl from-lime-c100 to-white">
        ...
        <div class="flex w-full">
            <div class="lg:w-2/3 lg:p-16 lg:pl-32 lg:pr-24 p-6">
                ...
                <div class="paragraph py-6 text-lime-c900 text-center lg:text-left">
    ...
    <div class="book-sm lg:hidden bg-lime-c900 flex-col relative z-50 p-6">
        ...
        <div class="text-right">
            ...
            <div class="buttons flex justify-around p-4">
                <a class="rounded-full bg-orange-c500 border-2 border-orange-c500 hover:bg-transparent hover:text-orange-c500 text-white text-lg p-4"
                    href="{{ route('dashboard') }}">
        ...
        <div class="testimonials-sm lg:hidden flex-col justify-around">
            ...
            <div class="p-6">
                ...
                <div class="lg:hidden w-full h-auto flex justify-center items-center gap-6 p-2">
                    <div class="flex-col justify-center items-center">
                        <div class="py-2 flex justify-center items-center">
                            <a class="flex justify-center items-center rounded-full bg-orange-c500 hover:bg-transparent hover:text-orange-c500 text-white text-lg p-4 py-3"
                                href="{{ route('dashboard') }}">
                                Descargar Libro
                            </a>
                        </div>
            ...
            <div class="hidden lg:block w-1/2 p-16">
                ...
                <div class="buttons flex justify-around p-4">
                    <a class="rounded-full border-2 border-lime-c900 text-lime-c900 text-xl p-4 hover:bg-lime-c900 hover:text-white"
                        href="{{ route('dashboard') }}">
                        Descargar Libro</a>
                    <a class="rounded-full bg-orange-c500 border-2 border-orange-c500 hover:bg-transparent hover:text-orange-c500 text-white text-xl p-4"
                        href="{{ route('dashboard') }}">
                        Contactar</a>
                </div>
            </div>
