...
<head>
    <meta charset="UTF-8">
    <title>Add publication Form - Laravel 9 CRUD</title>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>name:</strong>
                        <input type="text" name="name" class="form-control" placeholder="publication Name">
                        @error('name')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>body</strong>
                        <input type="text" name="body" class="form-control" placeholder="publication Address">
                        @error('body')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="abstract" class="form-control" placeholder="publication Address">
                        @error('abstract')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>minimage</strong>
                        <input type="text" name="minimage" class="form-control" placeholder="publication Address">
                        @error('minimage')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
